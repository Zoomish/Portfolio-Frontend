...
const CONFIG = {
  github: {
    username: 'Zoomish', // Your GitHub org/user name. (This is the only required config)
  },
  projects: {
    github: {
      ...
      automatic: {
        ...
        exclude: {
          ...
          projects: [], // These projects will not be displayed. example: ['author/project-name', 'author/project-name2']
        },
      },
    },
    external: {
